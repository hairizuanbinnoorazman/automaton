...
func (s Extractor) GetCustomDimSettings(accountID, propertyID, profileID string) ([]*analytics.CustomDimension, error) {
...
func (s Extractor) GetCustomMetricSettings(accountID, propertyID, profileID string) ([]*analytics.CustomMetric, error) {
	mgmtService := s.getManagementService()
...
func (s Extractor) GetGoalSettings(accountID, propertyID, profileID string) ([]*analytics.Goal, error) {
	mgmtService := s.getManagementService()
...
func (s Extractor) GetProfileSettings(accountID, propertyID, profileID string) ([]*analytics.Profile, error) {
	mgmtService := s.getManagementService()
...
func (s Extractor) GetProfileLinkSettings(accountID, propertyID, profileID string) ([]*analytics.ProfileFilterLink, error) {
	mgmtService := s.getManagementService()
